...
// ---- DASHBOARD HTML (escaped backticks) ----
...
exports.handler = async (event) => {
  ...
  // ---- The function is invoked for paths under /.netlify/functions/loader ----
  // We'll handle:
  //  - GET with ?page=admin → dashboard (IP protected)
  //  - GET without ?page → list keys (for dashboard AJAX)
  //  - POST /save, /delete, / (validation)

  // ---- Admin dashboard (GET with ?page=admin) ----
  ...
  // Any other request (should not happen) – redirect to Discord
  return {
    statusCode: 302,
    headers: { Location: 'https://discord.gg/lol' },
    body: ''
